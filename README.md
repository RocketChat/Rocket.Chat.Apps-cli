...
### Uploading the app 
For uploading the app you need add to the required parameters in the serverInfo.json already created in the apps directory. It accepts two types of objects:-
